...
resource "azurerm_container_registry" "quant_acr" {
  name                          = var.acr_name
...
resource "azurerm_private_endpoint" "acr_private_endpoint" {
  ...
  private_service_connection {
    ...
    private_connection_resource_id = azurerm_container_registry.quant_acr.id
...
resource "azurerm_role_assignment" "acrpull" {
  ...
  scope                            = azurerm_container_registry.quant_acr.id
